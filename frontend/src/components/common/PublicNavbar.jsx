        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-[72px]">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {/* Location Selector Pill — Fixed to show on mobile and desktop */}
              <div className="relative" ref={locationRef}>
                <button 
                  onClick={() => setLocationMenuOpen(v => !v)}
                  className="flex items-center gap-1.5 sm:gap-2 bg-gray-50 hover:bg-gray-100 px-2.5 sm:px-3.5 py-1.5 sm:py-2 rounded-full cursor-pointer transition-colors border border-gray-200 group"
                >
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-gray-800">{selectedLocation}</span>
                ...
                <AnimatePresence>
                  {locationMenuOpen && (
                    <motion.div
                      ...
                      className="absolute right-0 mt-2 w-36 sm:w-40 bg-white border border-gray-100 rounded-xl shadow-xl shadow-black/5 overflow-hidden z-50"
                    >
                      <div className="py-1">
                        {LOCATIONS.map((loc) => (
                          <button
