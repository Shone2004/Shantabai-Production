    ...
    try {
      ...
      if (response.data.success) {
        ...
        setFood({
          ...
          imageUrl:
            item.images?.[0] ||
            'https://images.unsplash.com/photo-1574894709920-11b28e7367e3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
          ...
          ingredients:
            item.tags && item.tags.length > 0
              ? item.tags
              : ['Homemade', 'Freshly Prepared', 'Healthy Spices'],
          provider: {
            id: providerInfo._id,
            ...
            avatar:
              providerInfo.avatar ||
              'https://images.unsplash.com/photo-1577219491135-ce391730fb2c?w=256',
            joined: providerInfo.createdAt
              ? new Date(providerInfo.createdAt).getFullYear()
              : '2025',
            bio:
              providerInfo.bio ||
              'Passionate about sharing home cooking with the community.',
          ...
          reviews: [
            {
              ...
              user: 'John D.',
              rating: 5,
              comment: 'Absolutely delicious! Tastes just like home.',
              date: '2 days ago',
            },
            {
              id: 2,
              user: 'Sarah M.',
              rating: 4,
              comment: 'Very rich and flavorful. Will definitely order again.',
              date: '1 week ago',
            },
          ],
        });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="w-full lg:w-2/3">
            ...
            {/* Review Section — only shown to logged-in non-providers */}
            ...
            <div className="p-6 overflow-y-auto">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center justify-between bg-gray-50 border border-gray-200 rounded-xl p-3">
                  <span className="text-gray-600 font-medium">Portions</span>
                  <div className="flex items-center gap-3">
                    <button
                      type="button"
                      onClick={() =>
